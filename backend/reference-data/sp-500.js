// Composition du S&P 500, format Yahoo Finance (points remplacés par des tirets pour les classes d'actions, ex: BRK.B -> BRK-B).
// Liste figée en dur (composition mise à jour manuellement, change plusieurs fois par an).
// Source : Wikipedia "List of S&P 500 companies" (table des composants, extraction déterministe).
module.exports = [
  { symbol: 'MMM', name: "3M" },
  ...
  { symbol: 'AMZN', name: "Amazon (company)" },
  ...
  { symbol: 'DOW', name: "Dow Chemical Company" },
  ...
  { symbol: 'PODD', name: "Acton, Massachusetts" },
  ...
  { symbol: 'IRM', name: "Iron Mountain (company)" },
  ...
  { symbol: 'KKR', name: "Kohlberg Kravis Roberts" },
  ...
  { symbol: 'PTC', name: "PTC (software company)" },
  ...
  { symbol: 'VTR', name: "Ventas (company)" },
